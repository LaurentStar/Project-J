 ...
 */
public class ObjectExplosionFX {
...
//////////////////////////////////////////*/
    ...
    //Constructor//
    ///////////////
    public ObjectExplosionFX(Bitmap res) {
    ...
    public void setScreenProjectile(int x, int y, int degree, int magnitude) {
        ...
        _core_X_Vel_0 += Math.cos(_core_Degree_Gravity_11 * Static.DEG) * _core_Magnitude_12;
        _core_Y_Vel_1 += -Math.sin(_core_Degree_Gravity_11 * Static.DEG) * _core_Magnitude_12;
