 ...
 */
public class ObjectIceEnergySphere extends GameObject {
    /*//////////////////////////////////////////
 //                  Arrays                //
 //////////////////////////////////////////*/
    ...
    private Animation[] _animation_Cells = new Animation[1];
    ...
    //Constructor//
    ///////////////
    public ObjectIceEnergySphere(Bitmap res) {
        ...
        //INTEGERS DEFINING//
        /////////////////////
        _core_W_Hitbox_6 = GamePanel.WIDTH/(100/7);
        _core_H_Hitbox_7 = GamePanel.WIDTH/(100/7);
        _core_X_Coord_0 = (int) _core_X_Hitbox_2;
        _core_Y_Coord_1 = (int) _core_Y_Hitbox_3;
        _core_Height_2 = GamePanel.HEIGHT/(100/14); //Only take up 10% of the screen
        _core_Width_3 = GamePanel.WIDTH/(100/9); //Only take up 10% of the screen
        _core_Gravity_Type_4 = Static.DYNAMIC_GRAVITY;
        _core_Object_Type_5 = Static.ENERGYICESPHERE;
        ...
        _core_Degree_Gravity_11 = 270; //180 degrees on the unit circle going counter clockwise
    ...
    public void applyGravity(long deltaticks){
        _core_X_Vel_0 += Math.cos(_core_Degree_Gravity_11 * Math.PI/180) * Static.LIGHTER_GRAVITY * (deltaticks / 1000.f);
        _core_Y_Vel_1 += -Math.sin(_core_Degree_Gravity_11 * Math.PI/180) * Static.LIGHTER_GRAVITY * (deltaticks / 1000.f);
    ...
    public void setAnimations() {
        ...
        //A0 = AIM STRAIGHT
        Bitmap[] A0 = new Bitmap[5];
        A0[0] = Bitmap.createBitmap(spriteSheet, 0, 0, 104, 85);
        A0[1] = Bitmap.createBitmap(spriteSheet, 104, 0, 104, 85);
        A0[2] = Bitmap.createBitmap(spriteSheet, 104*2, 0, 104, 85);
        A0[3] = Bitmap.createBitmap(spriteSheet, 104*3, 0, 104, 85);
        A0[4] = Bitmap.createBitmap(spriteSheet, 104*4, 0, 104, 85);
        ...
        A0[3] = Bitmap.createScaledBitmap(A0[3], scaleValue, scaleValue, false);
        A0[4] = Bitmap.createScaledBitmap(A0[4], scaleValue, scaleValue, false);
    ...
    public void draw(Canvas canvas) {
        canvas.drawBitmap(_animation_Cells[0].getImage(), _core_X_Coord_0, _core_Y_Coord_1, null);
